import { generateSigner, percentAmount, publicKey, createSignerFromKeypair, signerIdentity } from '@metaplex-foundation/umi'
import { createUmi } from '@metaplex-foundation/umi-bundle-defaults'
import { base58 } from '@metaplex-foundation/umi/serializers';
import { createCollection, createPlugin, create, pluginAuthority, ruleSet, fetchAssetV1, fetchCollectionV1} from '@metaplex-foundation/mpl-core'
...
(async () => {
    ...
    console.log(`\nCollection Created: https://explorer.solana.com/tx/${signature}?cluster=devnet`);
})();
